...
> **Note:** apps installed from DMG cannot be updated with Homebrew. To switch to Homebrew (recommended for auto-updates), see below.

### Switching from DMG to Homebrew

If you previously installed from DMG and want auto-updates via Homebrew:

```bash
# 1. Remove the manually installed app
rm -rf /Applications/CountdownApp.app
